...
shows substantial noise.  For example, the report date based data
exhibits a spike on May 11th about 5,000 cases, far higher than the
incident based data shows.  The incident based data shows a slight
